...
mean_above_thresh1(vec = bilirubin_labs, thresh = 1.2)
?mean
...
2) Write an R function that will take an input vector and set any negative
...
3) Write an R function that will take an input vector and set any value below a 
...
4) Augment your function so that it checks that the input is a numeric vector
