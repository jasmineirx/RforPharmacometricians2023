...
x1 <- factor(rainbows, levels = rainbows)

x2 <- factor(rainbows, levels = sort(rainbows))
sort(rainbows)
x1[2]
x2[2]
...
as.Date(dt1) - as.Date("1994-03-08")
as.Date(dt2) - as.Date("1994-03-08")
...
sum(is.na(as.numeric(my_numbers)))
which(is.na(as.numeric(my_numbers))) |> length()
